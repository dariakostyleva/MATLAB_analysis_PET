...
fig1 = openfig('Q:\Documents\PET\MATLAB_figures_PET\C12_017_figs\C12_017_red_spilloff_image_1c_plato_rand1_corr.fig','invisible');
arr1 = get(get(gca,'Children'),'CData'); % getting data from figure as an array
fig1e = openfig('Q:\Documents\PET\MATLAB_figures_PET\C12_017_figs\C12_017_red_spilloff_image_1c_plato_rand1_corr_err.fig','invisible');
arr1e = get(get(gca,'Children'),'CData');
fig2 = openfig('Q:\Documents\PET\MATLAB_figures_PET\C12_017_figs\C12_017_red_spilloff_image_1c_plato_rand2_corr.fig','invisible');
arr2 = get(get(gca,'Children'),'CData'); % getting data from figure as an array
fig2e = openfig('Q:\Documents\PET\MATLAB_figures_PET\C12_017_figs\C12_017_red_spilloff_image_1c_plato_rand2_corr_err.fig','invisible');
arr2e = get(get(gca,'Children'),'CData');
fig3 = openfig('Q:\Documents\PET\MATLAB_figures_PET\C12_017_figs\C12_017_red_spilloff_image_1c_plato_rand3_corr.fig','invisible');
arr3 = get(get(gca,'Children'),'CData'); % getting data from figure as an array
fig3e = openfig('Q:\Documents\PET\MATLAB_figures_PET\C12_017_figs\C12_017_red_spilloff_image_1c_plato_rand3_corr_err.fig','invisible');
arr3e = get(get(gca,'Children'),'CData');
fig4 = openfig('Q:\Documents\PET\MATLAB_figures_PET\C12_017_figs\C12_017_red_spilloff_image_1c_plato_rand4_corr.fig','invisible');
arr4 = get(get(gca,'Children'),'CData'); % getting data from figure as an array
fig4e = openfig('Q:\Documents\PET\MATLAB_figures_PET\C12_017_figs\C12_017_red_spilloff_image_1c_plato_rand4_corr_err.fig','invisible');
arr4e = get(get(gca,'Children'),'CData');
fig5 = openfig('Q:\Documents\PET\MATLAB_figures_PET\C12_017_figs\C12_017_red_spilloff_image_1c_plato_rand5_corr.fig','invisible');
arr5 = get(get(gca,'Children'),'CData'); % getting data from figure as an array
fig5e = openfig('Q:\Documents\PET\MATLAB_figures_PET\C12_017_figs\C12_017_red_spilloff_image_1c_plato_rand5_corr_err.fig','invisible');
arr5e = get(get(gca,'Children'),'CData');
fig6 = openfig('Q:\Documents\PET\MATLAB_figures_PET\C12_017_figs\C12_017_red_spilloff_image_1c_plato_rand6_corr.fig','invisible');
arr6 = get(get(gca,'Children'),'CData'); % getting data from figure as an array
fig6e = openfig('Q:\Documents\PET\MATLAB_figures_PET\C12_017_figs\C12_017_red_spilloff_image_1c_plato_rand6_corr_err.fig','invisible');
arr6e = get(get(gca,'Children'),'CData');
fig7 = openfig('Q:\Documents\PET\MATLAB_figures_PET\C12_017_figs\C12_017_red_spilloff_image_1c_plato_rand7_corr.fig','invisible');
arr7 = get(get(gca,'Children'),'CData'); % getting data from figure as an array
fig7e = openfig('Q:\Documents\PET\MATLAB_figures_PET\C12_017_figs\C12_017_red_spilloff_image_1c_plato_rand7_corr_err.fig','invisible');
arr7e = get(get(gca,'Children'),'CData');
fig8 = openfig('Q:\Documents\PET\MATLAB_figures_PET\C12_017_figs\C12_017_red_spilloff_image_1c_plato_rand8_corr.fig','invisible');
arr8 = get(get(gca,'Children'),'CData'); % getting data from figure as an array
fig8e = openfig('Q:\Documents\PET\MATLAB_figures_PET\C12_017_figs\C12_017_red_spilloff_image_1c_plato_rand8_corr_err.fig','invisible');
arr8e = get(get(gca,'Children'),'CData');
fig9 = openfig('Q:\Documents\PET\MATLAB_figures_PET\C12_017_figs\C12_017_red_spilloff_image_1c_plato_rand9_corr.fig','invisible');
arr9 = get(get(gca,'Children'),'CData'); % getting data from figure as an array
fig9e = openfig('Q:\Documents\PET\MATLAB_figures_PET\C12_017_figs\C12_017_red_spilloff_image_1c_plato_rand9_corr_err.fig','invisible');
arr9e = get(get(gca,'Children'),'CData');
fig10 = openfig('Q:\Documents\PET\MATLAB_figures_PET\C12_017_figs\C12_017_red_spilloff_image_1c_plato_rand10_corr.fig','invisible');
arr10 = get(get(gca,'Children'),'CData'); % getting data from figure as an array
fig10e = openfig('Q:\Documents\PET\MATLAB_figures_PET\C12_017_figs\C12_017_red_spilloff_image_1c_plato_rand10_corr_err.fig','invisible');
arr10e = get(get(gca,'Children'),'CData');
fig11 = openfig('Q:\Documents\PET\MATLAB_figures_PET\C12_017_figs\C12_017_red_spilloff_image_1c_plato_rand11_corr.fig','invisible');
arr11 = get(get(gca,'Children'),'CData'); % getting data from figure as an array
fig11e = openfig('Q:\Documents\PET\MATLAB_figures_PET\C12_017_figs\C12_017_red_spilloff_image_1c_plato_rand11_corr_err.fig','invisible');
arr11e = get(get(gca,'Children'),'CData');
fig12 = openfig('Q:\Documents\PET\MATLAB_figures_PET\C12_017_figs\C12_017_red_spilloff_image_1c_plato_rand12_corr.fig','invisible');
arr12 = get(get(gca,'Children'),'CData'); % getting data from figure as an array
fig12e = openfig('Q:\Documents\PET\MATLAB_figures_PET\C12_017_figs\C12_017_red_spilloff_image_1c_plato_rand12_corr_err.fig','invisible');
arr12e = get(get(gca,'Children'),'CData');
fig13 = openfig('Q:\Documents\PET\MATLAB_figures_PET\C12_017_figs\C12_017_red_spilloff_image_1c_plato_rand13_corr.fig','invisible');
arr13 = get(get(gca,'Children'),'CData'); % getting data from figure as an array
fig13e = openfig('Q:\Documents\PET\MATLAB_figures_PET\C12_017_figs\C12_017_red_spilloff_image_1c_plato_rand13_corr_err.fig','invisible');
arr13e = get(get(gca,'Children'),'CData');
fig14 = openfig('Q:\Documents\PET\MATLAB_figures_PET\C12_017_figs\C12_017_red_spilloff_image_1c_plato_rand14_corr.fig','invisible');
arr14 = get(get(gca,'Children'),'CData'); % getting data from figure as an array
fig14e = openfig('Q:\Documents\PET\MATLAB_figures_PET\C12_017_figs\C12_017_red_spilloff_image_1c_plato_rand14_corr_err.fig','invisible');
arr14e = get(get(gca,'Children'),'CData');
fig15 = openfig('Q:\Documents\PET\MATLAB_figures_PET\C12_017_figs\C12_017_red_spilloff_image_1c_plato_rand15_corr.fig','invisible');
arr15 = get(get(gca,'Children'),'CData'); % getting data from figure as an array
fig15e = openfig('Q:\Documents\PET\MATLAB_figures_PET\C12_017_figs\C12_017_red_spilloff_image_1c_plato_rand15_corr_err.fig','invisible');
arr15e = get(get(gca,'Children'),'CData');
fig16 = openfig('Q:\Documents\PET\MATLAB_figures_PET\C12_017_figs\C12_017_red_spilloff_image_1c_plato_rand16_corr.fig','invisible');
arr16 = get(get(gca,'Children'),'CData'); % getting data from figure as an array
fig16e = openfig('Q:\Documents\PET\MATLAB_figures_PET\C12_017_figs\C12_017_red_spilloff_image_1c_plato_rand16_corr_err.fig','invisible');
arr16e = get(get(gca,'Children'),'CData');
fig17 = openfig('Q:\Documents\PET\MATLAB_figures_PET\C12_017_figs\C12_017_red_spilloff_image_1c_plato_rand17_corr.fig','invisible');
arr17 = get(get(gca,'Children'),'CData'); % getting data from figure as an array
fig17e = openfig('Q:\Documents\PET\MATLAB_figures_PET\C12_017_figs\C12_017_red_spilloff_image_1c_plato_rand17_corr_err.fig','invisible');
arr17e = get(get(gca,'Children'),'CData');
fig18 = openfig('Q:\Documents\PET\MATLAB_figures_PET\C12_017_figs\C12_017_red_spilloff_image_1c_plato_rand18_corr.fig','invisible');
arr18 = get(get(gca,'Children'),'CData'); % getting data from figure as an array
fig18e = openfig('Q:\Documents\PET\MATLAB_figures_PET\C12_017_figs\C12_017_red_spilloff_image_1c_plato_rand18_corr_err.fig','invisible');
arr18e = get(get(gca,'Children'),'CData');
fig19 = openfig('Q:\Documents\PET\MATLAB_figures_PET\C12_017_figs\C12_017_red_spilloff_image_1c_plato_rand19_corr.fig','invisible');
arr19 = get(get(gca,'Children'),'CData'); % getting data from figure as an array
fig19e = openfig('Q:\Documents\PET\MATLAB_figures_PET\C12_017_figs\C12_017_red_spilloff_image_1c_plato_rand19_corr_err.fig','invisible');
arr19e = get(get(gca,'Children'),'CData');
fig20 = openfig('Q:\Documents\PET\MATLAB_figures_PET\C12_017_figs\C12_017_red_spilloff_image_1c_plato_rand20_corr.fig','invisible');
arr20 = get(get(gca,'Children'),'CData'); % getting data from figure as an array
fig20e = openfig('Q:\Documents\PET\MATLAB_figures_PET\C12_017_figs\C12_017_red_spilloff_image_1c_plato_rand20_corr_err.fig','invisible');
arr20e = get(get(gca,'Children'),'CData');

depth_pmma = [-79.7:2:159.3]; % scale for x axis in mm

figure;
title('File C12_017, 40 mm slice, reconstucted for 1 cycle from "plato" selected randomly 20 times, sensitivity corrected, spill-off events','Interpreter', 'none');
hold on
...
writematrix(data,'C12_017_rand_1c_plato.csv');
