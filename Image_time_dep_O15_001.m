...
fig1 = openfig('Q:\Documents\PET\MATLAB_figures_PET\O15_001_figs\O15_001_red_spilloff_image_1c_corr.fig','invisible');
arr1 = get(get(gca,'Children'),'CData'); % getting data from figure as an array
fig1e = openfig('Q:\Documents\PET\MATLAB_figures_PET\O15_001_figs\O15_001_red_spilloff_image_1c_corr_err.fig','invisible');
arr1e = get(get(gca,'Children'),'CData');
fig2 = openfig('Q:\Documents\PET\MATLAB_figures_PET\O15_001_figs\O15_001_red_spilloff_image_2c_corr.fig','invisible');
arr2 = get(get(gca,'Children'),'CData'); % getting data from figure as an array
fig2e = openfig('Q:\Documents\PET\MATLAB_figures_PET\O15_001_figs\O15_001_red_spilloff_image_2c_corr_err.fig','invisible');
arr2e = get(get(gca,'Children'),'CData');
fig3 = openfig('Q:\Documents\PET\MATLAB_figures_PET\O15_001_figs\O15_001_red_spilloff_image_3c_corr.fig','invisible');
arr3 = get(get(gca,'Children'),'CData'); % getting data from figure as an array
fig3e = openfig('Q:\Documents\PET\MATLAB_figures_PET\O15_001_figs\O15_001_red_spilloff_image_3c_corr_err.fig','invisible');
arr3e = get(get(gca,'Children'),'CData');
fig4 = openfig('Q:\Documents\PET\MATLAB_figures_PET\O15_001_figs\O15_001_red_spilloff_image_4c_corr.fig','invisible');
arr4 = get(get(gca,'Children'),'CData'); % getting data from figure as an array
fig4e = openfig('Q:\Documents\PET\MATLAB_figures_PET\O15_001_figs\O15_001_red_spilloff_image_4c_corr_err.fig','invisible');
arr4e = get(get(gca,'Children'),'CData');
fig7 = openfig('Q:\Documents\PET\MATLAB_figures_PET\O15_001_figs\O15_001_red_spilloff_image_7c_corr.fig','invisible');
arr7 = get(get(gca,'Children'),'CData'); % getting data from figure as an array
fig7e = openfig('Q:\Documents\PET\MATLAB_figures_PET\O15_001_figs\O15_001_red_spilloff_image_7c_corr_err.fig','invisible');
arr7e = get(get(gca,'Children'),'CData');
fig10 = openfig('Q:\Documents\PET\MATLAB_figures_PET\O15_001_figs\O15_001_red_spilloff_image_10c_corr.fig','invisible');
arr10 = get(get(gca,'Children'),'CData'); % getting data from figure as an array
fig10e = openfig('Q:\Documents\PET\MATLAB_figures_PET\O15_001_figs\O15_001_red_spilloff_image_10c_corr_err.fig','invisible');
arr10e = get(get(gca,'Children'),'CData');
fig30 = openfig('Q:\Documents\PET\MATLAB_figures_PET\O15_001_figs\O15_001_red_spilloff_image_30c_corr.fig','invisible');
arr30 = get(get(gca,'Children'),'CData'); % getting data from figure as an array
fig30e = openfig('Q:\Documents\PET\MATLAB_figures_PET\O15_001_figs\O15_001_red_spilloff_image_30c_corr_err.fig','invisible');
arr30e = get(get(gca,'Children'),'CData');
fig70 = openfig('Q:\Documents\PET\MATLAB_figures_PET\O15_001_figs\O15_001_red_spilloff_image_70c_corr.fig','invisible');
arr70 = get(get(gca,'Children'),'CData'); % getting data from figure as an array
fig70e = openfig('Q:\Documents\PET\MATLAB_figures_PET\O15_001_figs\O15_001_red_spilloff_image_70c_corr_err.fig','invisible');
arr70e = get(get(gca,'Children'),'CData');
fig100 = openfig('Q:\Documents\PET\MATLAB_figures_PET\O15_001_figs\O15_001_red_spilloff_image_100c_corr.fig','invisible');
arr100 = get(get(gca,'Children'),'CData'); % getting data from figure as an array
fig100e = openfig('Q:\Documents\PET\MATLAB_figures_PET\O15_001_figs\O15_001_red_spilloff_image_100c_corr_err.fig','invisible');
arr100e = get(get(gca,'Children'),'CData');
figall = openfig('Q:\Documents\PET\MATLAB_figures_PET\O15_001_figs\O15_001_red_spilloff_image_125c_corr.fig','invisible');
arrall = get(get(gca,'Children'),'CData'); % getting data from figure as an array
figalle = openfig('Q:\Documents\PET\MATLAB_figures_PET\O15_001_figs\O15_001_red_spilloff_image_125c_corr_err.fig','invisible');
arralle = get(get(gca,'Children'),'CData');

depth_pmma = [-49:2:190]; % scale for x axis in mm higher energy, pin 2
ncycle = 125; % total number of cycles in a file
...
figure;
title('File O15_001, 40 mm slice, reconstucted for different irradiation time, sensitivity corrected, SPILLOFF events','Interpreter', 'none');
hold on
...
%return;
writetable(data,'O15_001_time_variation.xls', 'WriteVariableNames', true);