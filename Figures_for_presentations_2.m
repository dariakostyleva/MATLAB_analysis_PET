...
figure;
hold on;
plot([-84:2:155],rescale(arr_O14(60,:)./map(60,:)),'DisplayName','14O');
plot([-84:2:155],rescale(arr_O15(60,:)./map(60,:)),'DisplayName','15O');
plot([-84:2:155],rescale(arr_O16(60,:)./map(60,:)),'DisplayName','16O');
hold off;
